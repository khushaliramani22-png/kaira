  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] flex items-center justify-center p-6 font-sans text-black">
      <div className="w-full max-w-md bg-white border border-gray-200 p-10 shadow-2xl relative">
        ...
        {errorMsg && (
          <div className="bg-black text-white text-[11px] py-3 px-4 mb-6 text-center uppercase tracking-tighter">
            {errorMsg}
          </div>
        )}
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button 
            type="submit" 
            className="w-full py-4 bg-black text-white font-bold uppercase tracking-widest hover:bg-gray-800 transition-all shadow-xl flex justify-center items-center"
            disabled={loading}
          >
            {loading ? (
