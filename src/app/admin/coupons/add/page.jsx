...
//         code: "",                // ખાલી સ્ટ્રિંગ
//         discount_type: "fixed",  // ડિફોલ્ટ વેલ્યુ
//         discount_value: "",      // ખાલી સ્ટ્રિંગ
//         min_cart_amount: "",     // ખાલી સ્ટ્રિંગ
//         expiry_date: "",         // ખાલી સ્ટ્રિંગ
//         is_first_order_only: false, // બુલિયન વેલ્યુ
//     });
...
//             setFormData({ code: "", discount_type: "fixed", discount_value: "", min_cart_amount: "", expiry_date: "", is_active: true });
//         }
//     };

//     return (
//         <div className="p-8 max-w-lg mx-auto bg-white rounded-2xl shadow-lg border">
...
//                         />
//                         <label className="form-check-label small fw-bold" htmlFor="firstOrder">
...
export default function AddCouponPage() {
  ...
  // બધા સ્ટેટ્સને ડિફોલ્ટ વેલ્યુ આપી દીધી છે જેથી React Error ના આવે
  const [formData, setFormData] = useState({
    code: "",
    discount_type: "fixed",
    discount_value: "",
