                                        ...
                                        <td className="p-4 text-right">
                                            <div className="grid grid-cols-2 gap-2 justify-end w-fit ">
                                                ...
                                                {order.status === "Confirmed" && (
                                                    <button onClick={() => updateStatus(order.id, order.status, "Delivered")} className="w-full sm:w-10 h-10 bg-gray-50 border border-gray-200 text-gray-500 rounded-xl flex items-center justify-center mt-2 hover:bg-black hover:text-white transition-all shadow-sm">
                                                        <Truck size={14} />
                                                    </button>
                                                )}
                                                ...
                                                {(order.status === "Exchange Requested" || order.status === "Exchange Pending") && (
                                                    <div className="flex flex-col gap-2 w-full sm:w-32">
                                                        <div className="relative group inline-block w-full">
                                                            <button
                                                                onClick={() => updateStatus(order.id, order.status, "Confirmed")}
                                                                className="bg-blue-600 text-white py-2.5 rounded-xl text-[9px] font-black uppercase flex items-center justify-center gap-1 hover:bg-blue-700 transition-all shadow-sm w-full"
                                                            >
                                                                <RefreshCw size={12} /> Approve
                                                            </button>
                                                            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block bg-gray-800 text-white text-[10px] px-2 py-1 rounded shadow-lg whitespace-nowrap z-50">
                                                                Approve Exchange
                                                        ...
                                                        <div className="relative group inline-block w-full">
                                                            ...
                                                            <button
                                                                ...
                                                                className="w-full border border-red-200 text-red-500 py-2.5 rounded-xl text-[9px] font-black uppercase flex items-center justify-center gap-1 hover:bg-red-50 transition-all shadow-sm"
                                                            >
                                                                <XCircle size={12} /> Reject
                                                            </button>

                                                            {/* ૨. કેપ્શન (Tooltip) - માઉસ લઈ જતાં જ દેખાશે */}
                                                            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block bg-red-600 text-white text-[10px] px-2 py-1 rounded shadow-lg whitespace-nowrap z-50 font-bold">
                                                                Reject Exchange & Mark Delivered
                                                                {/* ટૂલટિપનો નીચેનો નાનો એરો (Arrow) */}
