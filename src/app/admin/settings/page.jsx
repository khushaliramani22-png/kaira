                                            ...
                                            <div className="flex flex-col gap-2">
                                                <label className="text-xs font-semibold text-gray-500">Store Logo</label>
                                                    ...
                                                    <div className="space-y-2">
                                                        {formData.global.store_logo && formData.global.store_logo.trim() !== '' ? (
                                                            <>
                                                                <div className="flex items-center justify-between p-3 bg-green-50 border border-green-200 rounded-xl">
                                                                    <div className="flex items-center gap-2">
                                                                        <img 
                                                                            src={formData.global.store_logo.startsWith('http') ? formData.global.store_logo : `/images/colorbox/${formData.global.store_logo}`}
                                                                    ...
                                                                    <button
                                                                        type="button"
                                                                        onClick={() => {
                                                                            if (confirm('Remove store logo? This will revert to default SVG in header.')) {
                                                                                handleUpdate('global', 'store_logo', '');
                                                                            }
                                                                        }}
                                                                        className="p-1.5 bg-red-500 hover:bg-red-600 text-white rounded-lg text-xs font-bold transition-colors flex items-center gap-1"
                                                                        title="Remove Logo"
                                                                    >
                                                                        <X size={14} />
                                                                        Remove
