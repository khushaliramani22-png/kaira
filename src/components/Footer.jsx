...
//                   {["facebook", "twitter", "youtube", "pinterest", "instagram"].map(
//                     (social) => (
//                       <li key={social}>
...
export default function Footer() {
  const { settings } = useSettings();
  const email = settings?.global?.support_email || "kaira@gmail.com";
  const phone = settings?.global?.support_phone || "+91 00000 00000";

  // Help & Info લિંક્સનો ડેટા
  const helpLinks = [
    ...
    { name: "Find us easy", href: "/find-us" },
    { name: "Faqs", href: "/faqs" },
  ];
